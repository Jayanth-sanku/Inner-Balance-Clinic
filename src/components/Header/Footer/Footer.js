...
function Copyright(props) {
    return (
        <Typography variant="body2" color="text.secondary" align="center" {...props}>
            {'Developed with 🖤 by '}
            <strong><a className='text-style' href="https://github.com/Jayanth-sanku/" target="_blank" rel="noreferrer noopener">Jayanth Sanku</a> </strong>{'Copyright ©'}
                ...
                <Container maxWidth="xl">
                    <Grid container
                        ...
                        <Grid sx={{ m: 'auto' }} item xs={12} sm={6} md={4}>
                            ...
                            <Stack direction="row"
                                ...
                                <Avatar sx={{ mt: 1, bgcolor: pink[500] }}>
                                    <LocationOnIcon />
                                </Avatar><span>Srikakulam, Andhra Pradesh</span>
                            </Stack >
                        ...
                        <Grid item xs={12} sm={4}>
                            ...
                            <Box sx={{ p: 2 }}><HashLink className='text-style' to='/doctors#doctors' color='inherit'>Find a Psychiatrist</HashLink></Box>
                        ...
                        <Grid item xs={12} sm={4}>
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="https://www.linkedin.com/in/jayanth-sanku" target="_blank" rel="noopener noreferrer" >
                                    LinkedIn
                                </a>
                            </Stack >
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="https://github.com/Jayanth-sanku/" target="_blank" rel="noopener noreferrer" >
                                    GitHub
                                </a>
                            </Stack >
